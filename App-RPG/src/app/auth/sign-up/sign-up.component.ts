...
export class SignUpComponent implements OnInit {
  ...
  onSignUp(form: NgForm) {
    ...
    const pd: PersonalDataCreateModel = new PersonalDataCreateModel(form.value.login, form.value.email, form.value.firstname, form.value.lastname, form.value.city, form.value.age); 
