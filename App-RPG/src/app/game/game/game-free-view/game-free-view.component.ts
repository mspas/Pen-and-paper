...
@Component({
  selector: 'app-game-free-view',
  templateUrl: './game-free-view.component.html',
  styleUrls: ['./game-free-view.component.css']
})
export class GameFreeViewComponent implements OnInit {
